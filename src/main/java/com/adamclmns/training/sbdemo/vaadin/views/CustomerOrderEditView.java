...
@SpringView(name = CustomerOrderEditView.VIEW_NAME)
public class CustomerOrderEditView extends VerticalLayout implements View {
    private static final Logger log = LoggerFactory.getLogger(CustomerOrderEditView.class);
    ...
    //If you name them correctly, Binder picks them up automtically for binding, as long as they are all Strings... otherwise, you gotta map it yourself. 
    ...
    public void setChangeHandler(CustomerOrderEditView.ChangeHandler h) {
